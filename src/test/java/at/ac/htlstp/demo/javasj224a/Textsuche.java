...
public class Textsuche {
    ...
    public static void sucheNachFaust(List<String> data){
        Pattern p = Pattern.compile("(^|[^a-zA-ZöäüÖÄÜß])[Ff]aust($|[^a-zA-ZöäüÖÄÜß])");
        for(String line:data) {
    ...
    public static void sucheNachF_T(List<String> data){
        ...
        Pattern p = Pattern.compile("(^|[^a-zA-ZöäüÖÄÜß]|)(?<ft>[Ff]\\w*[tT])aust($|[^a-zA-ZöäüÖÄÜß])");
        Matcher m;
        for (String line:data) {
